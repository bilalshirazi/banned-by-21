...
.gr-samples .gallery img { height: 80px !important; border-radius: 8px !important; object-fit: cover !important; }
        ...
        with gr.Tab("Eligibility Checker", id="checker"):
            with gr.Row():
                with gr.Column(scale=1):
                    ...
                    gr.Examples(examples=EXAMPLES, inputs=[image_input], label="Try an Example Image", examples_per_page=12)
                with gr.Column(scale=1):
